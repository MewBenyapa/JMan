...
public abstract class Piece {
    ...
    public String getColorWord() {
    	if (this.getColor().equals(Color.RED)) { return "Red"; }
    	else if (this.getColor().equals(Color.GREEN)) { return "Green"; }
    	else if (this.getColor().equals(Color.YELLOW)) { return "Yellow"; }
    	else if (this.getColor().equals(Color.WHITE)) { return "White"; }
    	else { return ""; }
    }
